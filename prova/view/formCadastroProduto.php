   ...
   $('#cpf').blur(function()
   {
    ...
    <body>
                ...
                <div class="col-md-6 container-fluid">
                    <form  action="../controller/salvarCadastroProdutoController.php" method="post" id="form">
                    <label>Nome</label>
                    <input type="text" id="nome" name="nome" placeholder="Nome" class="form-control"><BR>
                    <label>Quantidade</label>
                        <input type="number" id="quantidade" name="quantidade" placeholder="Nº" class="form-control"><BR>
                          <label>Fabricante</label>
                          <input type="text" id="fabricante" name="fabricante" placeholder="Fabricante" class="form-control"><BR>
                        <label>Data de Cadastro</label>
                        <input type="date" id="dataCadastro" name="dataCadastro" placeholder="" class="form-control">
                    <label>Preço</label>
                        <input type="text" id="preco" name="preco" placeholder="Preço" class="form-control"><BR>
