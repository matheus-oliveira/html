        ...
        <div class="row">
            ...
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="hoverzoom">
                        <div class="col-md-4">
                            <img src="./images/roupas/Básicos/H58-1015-016_zoom1.jpg">
                            <div class="retina">
                                <p style="margin-top: 50% ">Camiseta Drezzup Evasê Feminina</p>
                            </div>
                        </div>
                    </div>
                    <div class="hoverzoom">
                        <img src="./images/roupas/Básicos/H58-1015-016_zoom1.jpg" class="img-responsive" id="estilo_imagem" style="width:100%" alt="Image">
                        <div class="retina">
                            <p style="margin-top: 50% ">Camiseta Drezzup Evasê Feminina</p>
                        </div>
                    </div>
